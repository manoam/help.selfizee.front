  ...
  return (
    <div className="mx-auto max-w-5xl px-4 md:px-6 py-8 md:py-12">
      <div className="mb-8 md:mb-10">
        <h1 className="text-2xl md:text-3xl font-bold text-[var(--a-text)] mb-2">
      ...
      {favourites.length > 0 && (
        <section className="mb-10">
          <h2 className="flex items-center gap-2 text-sm font-semibold text-[var(--a-text)] mb-3 uppercase tracking-wide">
            ...
            {favourites.slice(0, 4).map((p) => (
              ...
              >
                ...
                <div className="flex-1 min-w-0">
                  <div className="text-sm font-semibold text-[var(--a-text)] group-hover:text-[var(--a-accent)] transition">
                    {p.titre}
                  </div>
                  {p.resume && (
                    <p className="text-xs text-[var(--a-text-muted)] mt-1 line-clamp-2">
                      {p.resume}
                    </p>
                  )}
                </div>
          ...
          >
            <div className="flex items-center gap-4">
              ...
              <div className="flex-1 min-w-0">
                ...
                {cat.description && (
                  <p className="text-sm text-[var(--a-text-muted)] mt-1 line-clamp-2">
                    {cat.description}
                  </p>
                )}
              </div>
              <ChevronRight className="h-5 w-5 text-[var(--a-text-muted)] group-hover:text-[var(--a-accent)] transition shrink-0" />
            </div>
          </Link>
        ))}
      </div>
